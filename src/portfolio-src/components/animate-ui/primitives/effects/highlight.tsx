...
function Highlight(
  ...
  const [boundsState, setBoundsState] = React.useState<{ top: number; left: number; width: number; height: number; } | null>(null);
  ...
  React.useEffect(() => {
    safeSetBoundsRef.current = (bounds: DOMRect) => {
      ...
      const containerRect = (localRef.current as HTMLElement).getBoundingClientRect();
  ...
  React.useEffect(() => {
    ...
    const container = localRef.current as HTMLElement | null;
    if (!container) return;
