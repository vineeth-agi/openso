	...
	return (
		<div
			...
			className={cn(
				...
				// full-bleed (default) — use 100vw and constrain to avoid horizontal overflow
				"data-[contained=false]:left-1/2 data-[contained=false]:w-[100vw] data-[contained=false]:max-w-[100vw] data-[contained=false]:-translate-x-1/2",
				// contained
